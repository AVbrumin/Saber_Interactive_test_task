...
_OBJECT = 'an apple', 'a car', 'a boat', 'a rocket', 'a mall', 'a fish', 'a bottle of beer', 'a man'
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument('output_dir', metavar='<OUTPUT DIR>', type=str, help='path to dir with generated logs')
    parser.add_argument('-f', '--force', action='store_const', const=True, default=False,
                        help='force write logs', dest='force_write')
...
_RECORD_TEMPLATE = LogRecord(log_level='<LOG_LEVEL>', timestamp='<TIMESTAMP>', message='<MESSAGE>')
